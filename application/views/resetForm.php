        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas" style="position: fixed;">
                ...
                <section class="sidebar">
                        ...
                        <div class="pull-left image">
                          <!-- <a href="#"> <?php echo img('assets/img/logo.png', FALSE); ?> </a> -->
                        </div>
            ...
            <aside class="right-side">
            	<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Brian Otieno</a></li>
                        <li><a href="#">Home</a></li>
                        <li class="active">Reset Form</li>
                    </ol>
            </section>
               ...
               <section class="content-header">
                    <h1>
                        PASSWORD RESET 
                        <small>BRIAN OTIENO TEMPLATES</small>                
                   	</h1>
              </section>
			<?php echo br(2); ?>
                <!-- Main content -->
            ...
            <div class="col-md-6 col-md-offset-2">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading"> 					
                        ...
                        <h3 class="panel-title">Please Enter Your Email </h3>
                    	<?php echo form_open('main/resetPassword'); ?>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>                            	
								...
								echo form_label("Your Registered Email");
                               ...
                               <?php echo form_submit('submit', 'SEND CODE', 'class="btn btn-lg btn-success btn-block" ' ); ?>  
				...
				<div class="footer-panel panel panel-default">
							...
							<div>												
								...
								<br /> <?php echo br(2); echo "<a  href='http://www.brianotieno.com'>BRIAN OTIENO FOUNDATION </a>"; ?> 	</h6> 
								</div>  
							</div>
            </div>
        </div>
